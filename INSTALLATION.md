...
3. In Firestore settings, register a new **Web App** and copy the configuration object.
4. Open the `firebase.js` file in your project root and replace the default config with your own:
   ```javascript
